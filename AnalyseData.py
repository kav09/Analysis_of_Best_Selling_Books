...
class Analyse:
    ...
    def renamevalue(self):
        self.booklist['Author'] = self.booklist['Author'].str.replace(
    ...
    def changepricetoRupee(self):
        self.booklist['Price'] = self.booklist['Price'].map(
            lambda price: price*75)
...
# ____________________________________Author wise Book rating
    ...
    def getTopRateAuth(self, n):
        ...
        return ratingCount[ratingCount['User Rating'] > n].sort_values('User Rating', ascending=False).index
