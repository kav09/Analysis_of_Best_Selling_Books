    ...
    with st.spinner("Loading Data..."):
        ...
        with col1:
            ...
            st.plotly_chart(plotpie(data.index, data.values,
                                    'Pie Chart of Fiction Vs Non-Fiction', "seaborn"), use_container_width=True)
        with col2:
            data = analysis.getFicVsNonFic()
...
# -----------------------------------------------------------------------------
    ...
    st.markdown("___")
    st.markdown('<p class="head">Comparision of Genre</p>',unsafe_allow_html=True)
    ...
    with st.spinner("Loading Data..."):
        ...
        with st.spinner("Loading..."):
            ...
            st.markdown('<p class= "detail">Fiction Book Having Much Better Number of Reviews.</p>',unsafe_allow_html=True)
            st.markdown("___")
...
def analysebyAuthor():
    ...
    st.markdown('<h1 class="head">Select Author to know its Books Reviews Rating and Price</h1><b>',unsafe_allow_html=True)
    with st.spinner("Loading Data..."):
...
def analysebyReview():
    ...
    st.markdown('<p class="head">Histogram of Reviews</p>',unsafe_allow_html=True)
    ...
    st.markdown('<p class="head">Top 10 Reviewed Books And Authors.</p>',unsafe_allow_html=True)
    ...
    with col[0]:
        ...
        st.markdown('<p class="detail">Top Reviewed Author is "Delia Owens" with 87.841k.</p>',unsafe_allow_html=True)
    with col[1]:
        ...
        st.markdown('<p class="detail">Top Reviewed Book is "Where the Crawdads Sing" with 87.841k.</p>',unsafe_allow_html=True)
    sidebar.markdown(
...
# ---------------------------------------------------Histogram of Price
    with st.spinner("Loading.."):
        st.markdown('<h1 class="head">Histogram of Price.</h1><img>',unsafe_allow_html=True)
    ...
    st.markdown("")
    st.markdown('<p class="detail"> Above Plots Shows the Top 5 High Priced Books.</p>',unsafe_allow_html=True)
    st.markdown("___")

# -------------------------------------------Scatter Chart of comparision of price and user rating
    st.markdown('<p class="head">Relation Between Price and User Rating</p>',unsafe_allow_html=True)
    with st.spinner("Loading.."):
    ...
    st.markdown("")
    st.markdown("___")
    st.markdown('<p class="head">Number of Free BestSeller Over the Year </p>',unsafe_allow_html=True)
    with st.spinner("Loading Data..."):
    ...
    st.markdown('<p class="head">Number of Free Books Published By Author.</p>',unsafe_allow_html=True)
    ...
    st.markdown('<p class="detail">Harper Lee has Published the Maximum Free BestSeller Books.</p>',unsafe_allow_html=True)
    ...
    st.markdown('<p class="head">Average Reviews of Free And Paid Book Over Year</p>',unsafe_allow_html=True)
    data1 = analysis.freeBookAvgRating()
    data2 = analysis.BookAvgRating()
    ...
    with cols[0]:
        with st.spinner("Loading Data..."):
            ...
            st.markdown('<p class="detail">2017 have the maximum Average Review of Free Book</p>',unsafe_allow_html=True)
...
def analysebyYear():
    ...
    st.markdown('<h1 class="head">Average Review Over Year</h1><img>',unsafe_allow_html=True)
    col1, col2 = st.beta_columns(2)
    with col1:
    ...
    st.markdown('<h1 class="head">Average Price Over Years</h1><img>',unsafe_allow_html=True)
...
# -----------------------------------------Average Rating Over Years
    ...
    st.markdown('<h1 class="head">Average Rating Over Years</h1><img>',unsafe_allow_html=True)
...
# ---------------------------------------------View By Years
    st.markdown("___")
    st.markdown('<h1 class="head">View By Year</h1><img>',unsafe_allow_html=True)
    ...
    with st.spinner("Loading Data..."):
        ...
        st.markdown('<h1 class="head">Average Price and Rating Of Top Reviewed Authors Of the Year</h1><img>',unsafe_allow_html=True)    
...
def analysebyRating():
    ...
    st.markdown('<h1 class="head">Count the average Rating</h1><img>',unsafe_allow_html=True)
    with st.spinner('Loading...'):
        col = st.beta_columns(2)
        with col[0]:
        ...
        st.markdown('<p class="detail">MOST OF THE RATINGS ARE IN THE RANGE OF 4.6 TO 4.8</p>',unsafe_allow_html=True)
